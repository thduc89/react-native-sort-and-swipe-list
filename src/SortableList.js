...
//       .reverse()
  ...
  _onUpdateLayouts() {
    Promise.all([this._footerLayout, ...Object.values(this._rowsLayouts)]).then(
      ([footerLayout, ...rowsLayouts]) => {
        ...
        this._container.measure((x, y, width, height, pageX, pageY) => {
          ...
          this.setState(
            ...
            // i moved this animated: true up --justin
            // () => {
